...
A native MATLAB implementation of the algorithm (coded by [Andrei Zinovyev]() and [Evgeny Mirkes](https://github.com/Mirkes)) is also [available](https://github.com/auranic/Elastic-principal-graphs)
